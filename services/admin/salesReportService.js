...
export const loadSalesReportService = async ({ period = 'month', startDate, endDate }) => {
...
export const exportSalesReportExcelService = async ({ period = 'month', startDate, endDate }) => {
    ...
    const filename = `sales-report-${period}.xlsx`;

    return { wb, filename };
};

export const exportSalesReportPDFService = async ({ period = 'month', startDate, endDate }) => {
    const { start, end, label } = getDateRange(period, startDate, endDate);
    ...
    const filename = `sales-report-${period}.pdf`;
